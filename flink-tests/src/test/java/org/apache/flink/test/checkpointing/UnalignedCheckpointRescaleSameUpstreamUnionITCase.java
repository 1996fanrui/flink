...
/**
 * Integration test for unaligned checkpoint rescaling when a normal one-input downstream task
 * receives two union inputs derived from the same upstream stream.
 */
@ExtendWith(ParameterizedTestExtension.class)
class UnalignedCheckpointRescaleSameUpstreamUnionITCase {
    ...
    private static final String SLOW_MAP_NAME = "Slow Map";
    ...
    @TestTemplate
    void testRescaleFromUnalignedCheckpointWithSameUpstreamUnion(
